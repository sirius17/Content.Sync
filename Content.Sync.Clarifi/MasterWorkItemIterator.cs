...
{
    public class MasterWorkItemIterator : IWorkItemIterator
    {
        public MasterWorkItemIterator(string supplierFamily, long revision)
        {
        ...
        [Dependency]
        public IMasterWorkItemDb Db { get; set; }
